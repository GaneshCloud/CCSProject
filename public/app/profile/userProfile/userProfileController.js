...
(function() {
    ...
    function userProfileController($scope,$window,userProfileService,ngProgressFactory,spinnerService,userDashboardService) {
        ...
        $scope.getView = function(value) {
            if (value == 'local' && localStorage.getItem('localView') == 'true') {
                return true;
            }
            if (value == 'facebook' && localStorage.getItem('facebookView') == 'true') {
                return true;
            }
            if (value == 'google' && localStorage.getItem('googleView') == 'true') {
                return true;
            }
            return false;
        };
